...
use frontier_runtime::{self, opaque::Block, RuntimeApi, SLOT_DURATION};
...
native_executor_instance!(
	pub Executor,
	frontier_runtime::api::dispatch,
	frontier_runtime::native_version,
);
...
pub enum ConsensusResult {
	Aura(
		sc_consensus_aura::AuraBlockImport<
			...
			AuraPair
		>,
		sc_finality_grandpa::LinkHalf<Block, FullClient, FullSelectChain>, Option<TelemetrySpan>,
	),
...
>, ServiceError> {
	...
	Ok(sc_service::PartialComponents {
		...
		other: (ConsensusResult::Aura(aura_block_import, grandpa_link, telemetry_span), pending_transactions)
	})
}
...
pub fn new_full(
	...
	match consensus_result {
		...
		ConsensusResult::Aura(aura_block_import, grandpa_link, telemetry_span) => {
