...
use sp_runtime::traits::{
	BlakeTwo256, Block as BlockT, Verify, IdentifyAccount, NumberFor, IdentityLookup
};
...
use pallet_evm::{
	Account as EVMAccount, FeeCalculator, IdentityAddressMapping,
	EnsureAddressNever, EnsureAddressSame, Runner,
};
...
impl pallet_evm::Config for Runtime {
	...
	type Precompiles = precompiles::SelendraPrecompiles<Self>;
